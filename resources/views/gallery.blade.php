					...
					<div class="container">
						<div class="projects-container column-projects">
							...
							<div class="col-md-4 col-sm-6 project development image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Rita</strong> Fiva</h3>
							...
							<div class="col-md-4 col-sm-6 project branding image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Hospital</strong> Management</h3>
										<a href="#" class="btn btn-primary btn-white">See Project</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6 project print image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Goal</strong>Management</h3>
										<a href="#" class="btn btn-primary btn-white">See Project</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6 project print image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Branding</strong> Management</h3>
										<a href="#" class="btn btn-primary btn-white">See Project</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6 project branding image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Loreto</strong>Management</h3>
										<a href="#" class="btn btn-primary btn-white">See Project</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-6 project development image-holder">
								...
								<div class="hover-state">
									<div class="align-vertical">
										<h3 class="text-white"><strong>Lorem</strong>Management</h3>
										<a href="#" class="btn btn-primary btn-white">See Project</a>
									</div>
								</div>
							</div>
